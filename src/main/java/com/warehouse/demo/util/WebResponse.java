...
public class WebResponse<T> {
    ...
    public WebResponse<T> success(T data) {
        this.meta = new Meta(true, HttpStatus.OK.value(), "ok");
        this.data = data;
        return this;
    }
    ...
    public WebResponse<T> failure(int statusCode) {
        ...
        this.meta = new Meta(false, statusCode, "error");
        return this;
    }
    ...
    public WebResponse<T> failure() {
        ...
        this.meta = new Meta(false, HttpStatus.INTERNAL_SERVER_ERROR.value(), "error");
        return this;
    }
    ...
    public WebResponse<T> failure(String message) {
        ...
        this.meta = new Meta(false, HttpStatus.INTERNAL_SERVER_ERROR.value(), message);
        return this;
    }
    ...
    public WebResponse<T> failure(int statusCode, String message) {
        ...
        this.meta = new Meta(false, statusCode, message);
        return this;
    }
    ...
    public WebResponse<T> noLogin() {
        ...
        this.meta = new Meta(false, 302, "未登录或会话已过期，请重新登录！");
        return this;
    }
    ...
    public WebResponse<T> unAuthorized() {
        ...
        this.meta = new Meta(false, 401, "您正在尝试访问未授权的功能!");
        return this;
    }
